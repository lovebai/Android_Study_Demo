...
public class HorAdapter extends RecyclerView.Adapter<HorAdapter.LinearViewHolder> {
    ...
    public HorAdapter(Context context, OnClickItem onClickItem){
    ...
    public LinearViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new LinearViewHolder(LayoutInflater.from(context).inflate(R.layout.activity_hor_linear_item,parent,false));
    }
